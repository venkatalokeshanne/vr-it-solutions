    ...
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Map iframe */}
          <motion.div className="w-full h-[400px] rounded-2xl overflow-hidden shadow-lg">
            <iframe
          ...
          {/* Contact Information */}
          <motion.div className="bg-gradient-to-r from-primary/15 via-primary/10 to-transparent backdrop-blur-sm rounded-2xl p-8 border border-primary/5 shadow-lg">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    506/A, Aditya Enclave,
                    <br />
                    Nilagiri Block, 5th Floor,
                    <br />
                    Ameerpet, Hyderabad
                    <br />
                    Telangana - 500016
