...
export const metadata = {
  ...
  description: 'The terms and conditions that govern your use of VR IT Solutions website and services',
};
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="p-8">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              By using this website or its Products and Services, You Agree and Warrant that you have read, understood, and agreed to be bound by these terms. The company's privacy policy can be found at <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>. If you do not accept these terms, you must not use - and are not authorized to use - all or any portion of the company's website and its products or services (as defined below).
            </p>
          </section>
          
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Please read these points carefully before you use the services of this site:</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Website usage guidelines</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Links and Hyperlinks Terms</h2>
            <p className="text-gray-700 leading-relaxed">
              This website may have links to other websites. We do not undertake any control over the content of these websites; nor are we responsible for their website content. The sole purpose of the included links is to provide users with the right information. Hence, VRIT solutions will not be held responsible for any of the third-party content.
            </p>
            <p className="text-gray-700 leading-relaxed mt-4">
              Also, please adhere to the following set of guidelines:
            </p>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Claims of Intellectual Property Violations</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Subscription Services</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Limit of Liability</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Indemnity</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Pricing Disclaimer</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Proprietary Use of VRIT solutions Study Material</h2>
            <p className="text-gray-700 leading-relaxed">
